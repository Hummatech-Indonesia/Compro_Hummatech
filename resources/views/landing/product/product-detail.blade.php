...
@section('style')
    <style>
        .uk-slider-items>div {
            padding: 0 10px;
            /* Optional: adjust padding between slides */
            margin-right: 20px;
            ...
            <div class="uk-grid uk-grid-large uk-flex uk-flex-middle" data-uk-grid>
                <div class="uk-width-3-5@m uk-flex uk-flex-middle uk-margin-large-bottom">
                    <div class="in-equity-video">
                        <img class="uk-border-rounded uk-width-1-1" src="{{ asset('storage/' . $product->image) }}"
                            data-src="{{ asset('storage/' . $product->image) }}" alt="sample-images" width="433"
                            height="255" data-uk-img>
                    </div>
                </div>
                <div class="uk-width-2-5@m uk-flex uk-flex-middle">
                    <div>
                        ...
                        @if ($product->link != null)
                            <a href="{{ $product->link }}"
                                class="uk-button uk-button-primary uk-border-rounded uk-margin-small-top">Kunjungi Website
        ...
        <div class="uk-section">
            <div class="uk-container">
                <div class="uk-grid">
                    ...
                    <div class="uk-grid uk-grid-large uk-child-width-1-3@m uk-margin-medium-top uk-grid-stack uk-flex-center"
                        data-uk-grid>
                    ...
                    @foreach ($testimonials as $testimonial)
                        <div class="uk-grid-margin uk-first-column">
                            <div class="uk-background-contain uk-background-top-left" data-src="img/in-equity-4-blob-1.svg"
                                data-uk-img
                                style="background-image: url(&quot;https://www.indonez.com/html-demo/equity/img/in-equity-4-blob-1.svg&quot;);">
                                <div class="uk-flex uk-flex-middle">
                                    <div class="uk-margin-right">
                                        <div class="uk-background-primary uk-border-pill">
                                            <img class="uk-align-center uk-border-pill"
                                                src="{{ asset('storage/' . $testimonial->image) }}"
                                                data-src="{{ asset('storage/' . $testimonial->image) }}" alt="client-1"
                                    ...
                                    <div>
                                        ...
                                        <p class="uk-text-muted uk-margin-remove-top">
                                            {{ \Carbon\Carbon::parse($testimonial->created_at)->locale('id')->isoFormat('dddd, D MMMM Y') }}
                                        </p>
                                    </div>
                                </div>
                                <blockquote>
